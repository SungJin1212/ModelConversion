...
class CSCodeGenerator {
    ...
    public void CSModelCodeGeneration(MapModelInfo mapModelInfo, ArrayList<SystemEntityModelInfo> CSEntityModelInfoList, IntegrationModelInfo integrationModelInfo) {
        ...
        for (SystemEntityModelInfo systemEntityModelInfo : CSEntityModelInfoList) {
